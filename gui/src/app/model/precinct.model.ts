...
export class Precinct extends Control {
    county: string;
    geoId: string;
    demographics: any;
    votingSet: any;
    ...
    constructor(opts, precinct, private mapService: MapService) {
        super(opts);
        this.county = precinct.county;
        this.geoId = precinct.geoId;
        this.demographics = precinct.demographics;
        this.votingSet = precinct.votingSet;
        this.demographicBloc = precinct.demographicBloc;
        this.votingBloc = precinct.votingBloc;
        this.partyBloc = precinct.partyBloc;
        this.geography = precinct.geography;
        this.neighbor = precinct.neighbor;
